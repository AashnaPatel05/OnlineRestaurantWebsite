...
The system is built using Java, JSF (Jakarta Faces), and Apache Derby database.
...
3. Run the project
4. Open browser:
   http://localhost:8080/OnlineRestaurantWebsite
...
You can use the provided `database.sql` file to:
- Create tables
- Insert sample data
